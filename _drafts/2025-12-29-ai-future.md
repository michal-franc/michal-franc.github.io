...
**My personal experience:** I had opportunity to try Waterfall (It wasn't as bad as the current myths portray it). But I entered market with already big ideas like DDD, Agile on the horizon so it was easy to switch over to it.
...
Code was always a tool not the goal in itself. Software engineering has always been about building things and solving problems that humans face. All economic activity is ultimately driven by human needs, and our job is to figure out and build systems to address them.
